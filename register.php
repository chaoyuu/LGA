            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'chaoyu995@gmail.com';                     //SMTP username
                        $mail->Password   = 'ycy929979';                               //SMTP password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                        //Recipients
                        $mail->setFrom('chaoyu995@gmail.com');
...
<head>
    <title>Public  schools address to LGA Mapping</title>
    <!-- Meta tag Keywords -->
